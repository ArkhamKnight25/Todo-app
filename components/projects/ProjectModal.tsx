          ...
          <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
              />
            </div>
              ...
              <div className="grid grid-cols-5 gap-2">
                <button
                  ...
                  className={`w-8 h-8 rounded border-2 flex items-center justify-center text-sm ${
                    !formData.icon ? 'border-gray-400 dark:border-gray-500 bg-gray-100 dark:bg-gray-600' : 'border-gray-200 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'
                  } transition-colors`}
                >
                  ✕
                </button>
                {icons.map((icon) => (
                  <button
                    ...
                    onClick={() => setFormData(prev => ({ ...prev, icon }))}
                    className={`w-8 h-8 rounded border-2 flex items-center justify-center text-sm ${
                      formData.icon === icon ? 'border-gray-400 dark:border-gray-500 bg-gray-100 dark:bg-gray-600' : 'border-gray-200 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'
                    } transition-colors`}
                  >
                    {icon}
                  </button>
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="createDefaultSections" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            <div className="flex justify-end space-x-3 pt-4">
              <button
                type="button"
                onClick={handleClose}
                className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                disabled={loading}
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-4 py-2 text-sm font-medium text-white bg-blue-600 dark:bg-blue-500 border border-transparent rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                disabled={loading}
              >
                {loading && (
